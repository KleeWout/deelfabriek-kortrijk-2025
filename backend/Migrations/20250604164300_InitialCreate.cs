        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    PickupCode = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.InsertData(
                table: "Items",
                columns: new[] { "Id", "Accesories", "CreatedAt", "Description", "Dimensions", "HowToUse", "ImageSrc", "LockerId", "PricePerWeek", "Status", "TimesLoaned", "Tip", "Title", "Weight" },
                values: new object[,]
                {
                    { 1, "4 spoeltjes", new DateTime(2023, 6, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, null, null, null, 5.00m, "Beschikbaar", 0, null, "Naaimachine", null },
                    { 2, "1x 18 V Klopboor-/schroefmachine, 2x 3.0 Ah accu, 1x Snellader, 1x Mbox", new DateTime(2023, 6, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "Uiterst geschikt voor allround (klop)boor- en schroefwerkzaamheden. 3 functies: schroeven, boren en klopboren. Hoog werkcomfort door uitstekende machinebalans en compact formaat.", null, "Zie handleiding: https://www.icmsmakita.eu/cms/custom/nl/attachments/user_manual/DHP485_20240320_885653D991_DU884.pdf", "https://shop.lecot.be/nl-be/makita-accu-schroef-en-klopboormachine-dhp485rfj-18v-2-x-3-ah-li-ion", null, 5.00m, "Beschikbaar", 0, null, "Schroef- en Klopboormachine", 1.5m },
                    { 3, "1 x kraanstuk, 1 x adapter, 1 x slangstuk, 1 x waterstop, 1 x tuinspuit", new DateTime(2023, 6, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "GARDENA Comfort FLEX slang met Original accessoires. Drukbestendig, vormvast, knikt en verdraait niet.", null, null, "https://www.hubo.be/nl/p/gardena-flex-tuinslang-13mm-1-2-20m-accessoires/509258/", null, 2.00m, "Beschikbaar", 0, null, "Gardena tuinslang 20m", null },
                    { 4, "/", new DateTime(2023, 6, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "25 meter snoerlengte. Geschikt voor buiten. 230 voltage. 4 stopcontacten.", "44 x 29.7 cm", "Vergeet niet: de verlengkabel moet je volledig afrollen. Zo voorkom je oververhitting van de kabel.", null, null, 10.00m, "Beschikbaar", 0, null, "Verlengdraad", 7.9m },
                    { 5, "Vrieskom, Spatel", new DateTime(2023, 6, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "Zelf ijs maken. Geschikt voor roomijs en sorbet. Inhoud 1,5 liter.", "41 x 24 cm", "De ijsemmer moet eerst een nachtje in de vriezer. De vrieskom moet volledig bevroren zijn. Kan 6-22 uur duren afhankelijk van de vriezer.", "https://www.coolblue.be/nl/product/172042/cuisinart-de-luxe-ice30bce.html", null, 5.00m, "Beschikbaar", 0, "Controleer of de kom (20 x 16.5 cm) in je vriezer past.", "Ijsmachine", 7.0m }
                });
