    ...
    <div className="min-h-screen flex bg-[var(--color-primarybackground)]">
      ...
      <div className="flex flex-col justify-center items-center basis-1/2 gap-10">
        <div className="flex flex-col items-center gap-6 w-full max-w-[480px]">
          ...
          <h1 className="text-7xl font-semibold text-[var(--color-primarygreen-1)] mb-8">
            Deelkast
          </h1>
          <button
      ...
      <div className="flex flex-col justify-center items-center basis-1/2 gap-8">
        <div className="flex flex-col w-full max-w-[340px] items-center">
          <div className="text-2xl font-semibold text-[var(--color-primarygreen-1)] mb-1 w-full text-left whitespace-nowrap leading-tight">
            Ophalen of Terugbrengen
          </div>
          <div className="text-xl text-[var(--color-primarytext-1)] mb-4 w-full text-left">
            Geef uw code in
          </div>
          ...
          <button
            className="w-full h-16 bg-[var(--color-primarygreen-1)] text-white text-2xl rounded-lg font-semibold shadow hover:bg-[#00664f] transition"
            onClick={handleEnter}
          >
            Enter
          </button>
