...
export default function OphaalFlowPage() {
  ...
  const imageSrc = reservationData?.item?.imageSrc ? getApiUrl(`/images/${reservationData.item.imageSrc}`) : "/assets/items/naaimachine.png";
        ...
        <div className="w-[340px] bg-white border-2 border-[var(--color-secondarygreen-1)] rounded-2xl p-7 flex flex-col gap-5 shadow-xl min-h-[320px] justify-start">
          ...
          <button
            ...
            onClick={() => {
              ...
              // router.push(`/kiosk/payment/${reservationData?.pickupCode || 0}`);
            }}
          >
            Betalen
          </button>
