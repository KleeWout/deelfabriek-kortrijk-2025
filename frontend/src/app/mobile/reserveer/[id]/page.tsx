...
export default function ReservationPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50 pb-16">
      <Navigation />
      <ReturnButton href={`/mobile/items/${item.id}`} />

      <div className="container mx-auto px-4 mt-4 ">
        <div className="flex flex-col md:flex-row-reverse gap-12">
          <div>
            <h2 className="text-2xl font-extrabold text-primarygreen-1 mb-2">Huur termijn</h2>

            <div className="bg-primarygreen-2 border border-primarygreen-1 rounded-lg p</div>-6 mb-6 p-8">
              ...
              <div className="text-center">
                ...
                <div className="bg-gray-50 rounded-lg  text-center px-3 py-2 mx-8 my-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-4">
              <h2 className="text-2xl font-extrabold text-primarygreen-1 mb-2">Contactgegevens</h2>
