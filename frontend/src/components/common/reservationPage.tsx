...
export default function ReservationPage() {
  ...
  const totalPrice = (item.pricePerWeek * formData.duration)
    .toFixed(2)
    .replace('.', ',');
        ...
        <div>
          ...
          <div className="bg-primarygreen-2 border border-primarygreen-1 rounded-lg p-6 mb-6">
            ...
            <div className="text-center text-sm text-primarytext-1 m-4">
              Prijs: € {item.pricePerWeek.toFixed(2).replace('.', ',')} per week
            </div>
          ...
          <div className="bg-red-100 rounded-lg p-4 mb-6 text-center text-red-900 border border-red-800 text-sm font-semibold">
            48 uur om uw item op te halen anders wordt de reservatie
            geannuleerd!
          </div>
        </div>
