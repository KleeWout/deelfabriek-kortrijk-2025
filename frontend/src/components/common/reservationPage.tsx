    ...
    <div className="pb-16  ">
      <div className="container  mx-auto p-8 flex flex-col lg:flex-row-reverse items-start  gap-12 justify-center">
        <div>
          ...
          <div className="bg-red-100 rounded-lg p-4 mb-6 text-center text-red-900 border border-red-800 text-sm font-semibold">3 dagen om uw item op te halen anders wordt de reservatie geannuleerd!</div>
        </div>
        ...
        <form id="reservationForm" onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex justify-center items-center w-full gap-4">
            ...
            <button form="reservationForm" type="submit" disabled={isSubmitting} className="w-64 bg-primarygreen-1 text-white py-3 px-4 rounded-lg hover:bg-green-900 transition-colors disabled:bg-gray-400 cursor-pointer">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full flex flex-col items-center border border-primarygreen-1">
            ...
            <div className="flex gap-6 w-full justify-center">
              <button onClick={handleCancel} className=" border border-gray-300  px-6 py-3 rounded-lg text-gray-700 hover:bg-gray-100">
                Annuleren
              </button>
              <button onClick={handleConfirm} className=" bg-primarygreen-1 text-white  px-6 py-3 rounded-lg  hover:bg-green-700 disabled:bg-green-300">
                Ja, reserveren
              </button>
            </div>
          </div>
