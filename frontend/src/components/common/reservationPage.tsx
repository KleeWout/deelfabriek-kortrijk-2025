...
export default function ReservationPage() {
  ...
  return (
    <div className="pb-16  ">
      <div className="container  mx-auto p-8 flex flex-col lg:flex-row-reverse items-start  gap-12 justify-center">
        <div>
              ...
              {!isTabletRoute && (
                <div className="bg-gray-50 rounded-lg  text-center px-3 py-2">
                  <p className="text-gray-600 text-sm font-semibold">
                    Betaling gebeurd via Payconiq bij ophalen
                  </p>
                </div>
              )}
            </div>
          </div>
          <div className="bg-red-100 rounded-lg p-4 mb-6 text-center text-red-900 border border-red-800 text-sm font-semibold">
            3 dagen om uw item op te halen anders wordt de reservatie
            geannuleerd!
          </div>
        </div>
        ...
        >
          <div className="space-y-4">
            <h2 className="text-2xl font-bold  text-primarygreen-1 mb-8">
              Contactgegevens
            </h2>
          ...
          <div className="flex items-center mt-4">
            <input
              ...
              className="mr-2 w-5 h-5 accent-primarygreen-1"
              required
            />
            <label htmlFor="terms" className="text-sm select-none">
              ...
              <button
                ...
                className="underline text-primarygreen-1 hover:text-primarygreen-2 font-semibold focus:outline-none focus:underline"
              >
          ...
          <div className="flex justify-center items-center w-full gap-4">
            <button
              type="button"
              onClick={() =>
                router.push(isTabletRoute ? '/kiosk/items' : '/items')
              }
              className="w-40 border border-primarygreen-1 text-primarygreen-1 py-3 px-4 rounded-lg hover:bg-gray-200 transition-colors cursor-pointer"
            >
              Annuleren
            </button>
            ...
            <button
              ...
              className="w-64 bg-primarygreen-1 text-white py-3 px-4 rounded-lg hover:bg-green-900 transition-colors disabled:bg-gray-400 cursor-pointer"
            >
              {isSubmitting
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full flex flex-col items-center border border-primarygreen-1">
            ...
            <div className="flex gap-6 w-full justify-center">
              <button
                ...
                className=" border border-gray-300  px-6 py-3 rounded-lg text-gray-700 hover:bg-gray-100"
              >
                Annuleren
              </button>
              <button
                onClick={handleConfirm}
                className=" bg-primarygreen-1 text-white  px-6 py-3 rounded-lg  hover:bg-green-700 disabled:bg-green-300"
              >
                Ja, reserveren
              </button>
            </div>
